...
# Remove the unresolved import; OrderCancel may not exist in ibapi
...
def new_func():
    COMPETE_AGAINST_BEST_OFFSET_UP_TO_MID = float('inf')
    return COMPETE_AGAINST_BEST_OFFSET_UP_TO_MID

COMPETE_AGAINST_BEST_OFFSET_UP_TO_MID = new_func()
