...
from PySide6.QtWidgets import ( QApplication, QMainWindow, QWidget, QVBoxLayout, QHBoxLayout, QPushButton, QTabWidget, QLabel, QLineEdit, QComboBox, QTextEdit, QGroupBox, QTableWidget, QTableWidgetItem, QHeaderView, QMessageBox, QDoubleSpinBox, QAbstractItemView, QCheckBox, QSpinBox )
...
DATA_TYPE_MAP = { "Live": 1, "Frozen": 2, "Delayed": 3, "Delayed-Frozen": 4, "Historical": 5 }
...
class TradingApp(QMainWindow):
    ...
    def create_widgets(self):
        ...
        # Trendline params
        trend_box = QGroupBox("TrendlineBreakout")
        trend_layout = QHBoxLayout()
        trend_layout.addWidget(QLabel("Lookback:"))
        self.lookback_spin = QSpinBox()
        self.lookback_spin.setRange(1, 1000)
        self.lookback_spin.setValue(20)
        trend_layout.addWidget(self.lookback_spin)
        trend_layout.addSpacing(10)
        trend_layout.addWidget(QLabel("ATR Length:"))
        self.atr_length_spin = QSpinBox()
        self.atr_length_spin.setRange(1, 1000)
        self.atr_length_spin.setValue(14)
        trend_layout.addWidget(self.atr_length_spin)
        trend_layout.addSpacing(10)
        trend_layout.addWidget(QLabel("ATR Mult:"))
        self.atr_mult_spin = QDoubleSpinBox()
        self.atr_mult_spin.setRange(0.1, 10.0)
        self.atr_mult_spin.setSingleStep(0.1)
        self.atr_mult_spin.setValue(1.5)
        trend_layout.addWidget(self.atr_mult_spin)
        trend_layout.addStretch()
        trend_box.setLayout(trend_layout)
        params_v_layout.addWidget(trend_box)

        # Support/Resistance params
        supres_box = QGroupBox("SupportResistance")
        supres_layout = QHBoxLayout()
        supres_layout.addWidget(QLabel("Period:"))
        self.period_spin = QSpinBox()
        self.period_spin.setRange(1, 1000)
        self.period_spin.setValue(50)
        supres_layout.addWidget(self.period_spin)
        supres_layout.addStretch()
        supres_box.setLayout(supres_layout)
        params_v_layout.addWidget(supres_box)

        # FVG params
        fvg_box = QGroupBox("FairValueGap")
        fvg_layout = QVBoxLayout()
        fvg_row1_layout = QHBoxLayout()
        fvg_row1_layout.addWidget(QLabel("Min Gap Size:"))
        self.fvg_min_gap_spin = QDoubleSpinBox()
        self.fvg_min_gap_spin.setRange(0.0, 10.0)
        self.fvg_min_gap_spin.setSingleStep(0.1)
        self.fvg_min_gap_spin.setValue(0.1)
        fvg_row1_layout.addWidget(self.fvg_min_gap_spin)
        fvg_row1_layout.addSpacing(10)
        fvg_row1_layout.addWidget(QLabel("Max Candles:"))
        self.fvg_max_candles_spin = QSpinBox()
        self.fvg_max_candles_spin.setRange(1, 100)
        self.fvg_max_candles_spin.setValue(10)
        fvg_row1_layout.addWidget(self.fvg_max_candles_spin)
        fvg_row1_layout.addSpacing(10)
        fvg_row1_layout.addWidget(QLabel("BOS Lookback:"))
        self.fvg_bos_lookback_spin = QSpinBox()
        self.fvg_bos_lookback_spin.setRange(1, 200)
        self.fvg_bos_lookback_spin.setValue(100)
        fvg_row1_layout.addWidget(self.fvg_bos_lookback_spin)
        fvg_row1_layout.addSpacing(10)
        fvg_row1_layout.addWidget(QLabel("Range Threshold:"))
        self.fvg_range_thresh_spin = QDoubleSpinBox()
        self.fvg_range_thresh_spin.setRange(0.0, 1.0)
        self.fvg_range_thresh_spin.setSingleStep(0.01)
        self.fvg_range_thresh_spin.setValue(0.02)
        fvg_row1_layout.addWidget(self.fvg_range_thresh_spin)
        fvg_row1_layout.addStretch()
        fvg_layout.addLayout(fvg_row1_layout)

        fvg_row2_layout = QHBoxLayout()
        fvg_row2_layout.addWidget(QLabel("Lower Threshold:"))
        self.fvg_lower_thresh_spin = QDoubleSpinBox()
        self.fvg_lower_thresh_spin.setRange(0.0, 1.0)
        self.fvg_lower_thresh_spin.setSingleStep(0.01)
        self.fvg_lower_thresh_spin.setValue(0.02)
        fvg_row2_layout.addWidget(self.fvg_lower_thresh_spin)
        fvg_row2_layout.addSpacing(10)
        fvg_row2_layout.addWidget(QLabel("Upper Threshold:"))
        self.fvg_upper_thresh_spin = QDoubleSpinBox()
        self.fvg_upper_thresh_spin.setRange(0.0, 1.0)
        self.fvg_upper_thresh_spin.setSingleStep(0.1)
        self.fvg_upper_thresh_spin.setValue(0.6)
        fvg_row2_layout.addWidget(self.fvg_upper_thresh_spin)
        fvg_row2_layout.addSpacing(10)
        fvg_row2_layout.addWidget(QLabel("Support Lookback:"))
        self.fvg_support_lookback_spin = QSpinBox()
        self.fvg_support_lookback_spin.setRange(1, 100)
        self.fvg_support_lookback_spin.setValue(5)
        fvg_row2_layout.addWidget(self.fvg_support_lookback_spin)
        fvg_row2_layout.addSpacing(10)
        fvg_row2_layout.addWidget(QLabel("Support Tolerance:"))
        self.fvg_support_tolerance_spin = QDoubleSpinBox()
        self.fvg_support_tolerance_spin.setRange(0.0, 1.0)
        self.fvg_support_tolerance_spin.setSingleStep(0.01)
        self.fvg_support_tolerance_spin.setValue(0.01)
    ...
    def on_create_checked_strategies(self):
        try:
            ...
            params = {
                ...
                # TrendlineBreakout params
                "lookback": self.lookback_spin.value(),
                "atr_length": self.atr_length_spin.value(),
                "atr_mult": self.atr_mult_spin.value(),

                # SupportResistance params
                "period": self.period_spin.value(),

                # FVG params
                "min_gap_size": self.fvg_min_gap_spin.value(),
                "max_candles": self.fvg_max_candles_spin.value(),
                "lookback_bos": self.fvg_bos_lookback_spin.value(),
                "range_threshold": self.fvg_range_thresh_spin.value(),
                "lower_threshold": self.fvg_lower_thresh_spin.value(),
...
class FairValueGapStrategy(BaseStrategy):
    def __init__(self, app, symbol, params=None):
        ...
        self.min_gap_size = float(self.params.get("min_gap_size", 0.1))
        self.max_candles = int(self.params.get("max_candles", 10))
        self.lookback_bos = int(self.params.get("lookback_bos", 100))
        self.range_threshold = float(self.params.get("range_threshold", 0.02))
        self.lower_threshold = float(self.params.get("lower_threshold", 0.02))
    ...
    def _fvg_is_in_allowed_range(self, df, fvg_low, fvg_high, current_idx, direction="bullish"):
        ...
        if range_height <= 0: return False
